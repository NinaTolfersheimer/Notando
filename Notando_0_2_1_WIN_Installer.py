...
#PURPOSE: This script will set up the required directories and files for Notando 0.2.1 on your Windows device.
...
print('====================')
print('NOTANDO 0.2.1 – Installer for Windows')
print('====================')
print()
...
print('(4) Notando does only use data directly provided to the app by yourself (when Notando asks you to provide it) as well as your username and NO OTHER except for such already included in the initial software release file.')
print()
print()
