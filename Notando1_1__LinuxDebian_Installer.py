...
print('(1) This policy only applies to the unmodified versions of Notando provided by Nina Tolfersheimer or an approved distributor.')
...
print('(4) This original English version is the only one really applicable. This policy only underlies European and German law.')
...
print('(1) There is ABSOLUTELY NO WARANTY WHATSOEVER that Notando will work by any means on your device.')
...
print('(4) You are running Notando AT YOUR OWN RISK and are ENTIRELY RESPONSIBLE FOR EVERY DAMAGE that Notando may cause to your device.')
print()
print('IV. Data protection')
print('(1) By default, Notando is running completely local on your device.')
print('(2) It does not establish a connection to the internet, unless you modify it to do so. In this case, YOU are the only one responsible for ANY RISKS AND THREATS this may cause to your personal data')
print('(3) Because there is NO GUARANTEED PROTECTION to the data you store through the app, you should both')
